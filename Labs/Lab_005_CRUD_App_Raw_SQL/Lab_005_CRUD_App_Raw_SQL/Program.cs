...

{
    class Program
    {
...

        {
            ...
            connectionstring = $"Data Source=localhost;Initial Catalog=Northwind;Persist Security Info=True; User ID=sa;Password=Passw0rd2018";
            ...
            UpdateCustomer("ALFKI");
            DeleteCustomer("PHIL1");
            GetCustomers();
        }
        ...
        static void GetCustomers()
        {
            ...
            {
                //going to build a new customer list.
                customers = null;
        ...
        static void UpdateCustomer(string CustomerID)
        {
            ...
            {
                connection.Open();
                var customerIdToUpdate = CustomerID;
        ...
        static void DeleteCustomer(string CustomerID)
        {
            using (var connection = new SqlConnection(connectionstring2))
            {
                ...
                var customerIdToDelete = CustomerID;
